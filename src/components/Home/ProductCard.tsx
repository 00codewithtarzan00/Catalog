...
export default function ProductCard({ product, onClick }: ProductCardProps) {
  return (
    ...
    >
      <div className="relative aspect-square md:aspect-square aspect-[4/3] overflow-hidden bg-gray-50 border-b border-brand-border flex items-center justify-center">
        {product.imageUrl ? (
          <img
      ...
      <div className="p-2 md:p-4 flex flex-col min-h-24 md:min-h-32">
        <div className="text-[8px] md:text-[10px] uppercase tracking-wider text-brand-muted font-semibold mb-0.5 md:mb-1">
          {product.category}
        </div>
        <h3 className="font-display font-medium text-sm md:text-lg leading-tight line-clamp-2 mb-1 md:mb-2">
          {product.name}
        </h3>
        ...
        <div className="mt-auto flex flex-col">
          <div className="flex items-center gap-1 md:gap-2">
            ...
            {product.mrp && product.mrp > product.price && (
              <span className="text-[10px] md:text-xs text-brand-muted line-through">
